...
<body>
	...
	<ul>
		<li>core : 변수 선언, 객체 속성 수정, 삭제, if, for, redirect 등 핵심기능</li>
		<li>fmt : fotmat, 날짜나 숫자의 표현서식을 지정한다.</li>
		<li>fn : functions, split이나 length와 같은 간당한 함수들을 태그형식으로 지원한다.</li>
